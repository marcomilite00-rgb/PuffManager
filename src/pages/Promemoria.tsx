                            ...
                            <div className="relative z-10 space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-3 pt-2">
                                    ...
                                    <button
                                        ...
                                        className="col-span-2 py-3 px-4 bg-red-500/10 hover:bg-red-500/20 text-red-400 font-bold rounded-xl text-sm transition-colors border border-red-500/20 flex items-center justify-center gap-2"
                                    >
                                        <Trash2 size={16} />
                                        ELIMINA
                                    </button>
